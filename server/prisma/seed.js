...
async function main() {
  ...
  const categories = [
    ...
    {
      name: "Mix Juice",
      description: "Kombinasi buah-buahan",
      icon: "",
      order: 2,
    },
  ...
  const mixJuice = [
    {
      name: "Mix Tropical",
      description: "Mangga, Nanas, Jeruk",
      price: 18000,
      categoryId: createdCategories[1].id,
    },
    {
      name: "Mix Berry Blast",
      description: "Strawberry, Jambu, Melon",
      price: 20000,
      categoryId: createdCategories[1].id,
    },
    {
      name: "Mix Green Healthy",
      description: "Alpukat, Melon, Timun",
      price: 18000,
      categoryId: createdCategories[1].id,
    },
    {
      name: "Mix Summer Fresh",
      description: "Semangka, Nanas, Jeruk",
      price: 17000,
      categoryId: createdCategories[1].id,
    },
  ];
    ...
    data: {
      ...
      orderItems: {
        create: [
          {
            productId: (
              await prisma.product.findFirst({ where: { name: "Jus Jeruk" } })
            ).id,
            quantity: 1,
            price: 12000,
          },
          {
            productId: (
              await prisma.product.findFirst({ where: { name: "Jus Mangga" } })
            ).id,
            quantity: 1,
            price: 15000,
          },

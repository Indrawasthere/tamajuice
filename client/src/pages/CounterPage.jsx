...
export default function CounterPage() {
  ...
  const handleCheckout = async () => {
    ...
    try {
      ...
      alert('Gagal membuat order: ' + (error.response?.data?.message || 'Unknown error'));
    } finally {
      setProcessing(false);
    }
  };
            ...
            <div className="grid grid-cols-2 md:grid-cols-3 gap-3">
              {filteredProducts.map(product => (
                ...
                >
                  ...
                  <p className="text-primary-yellow font-bold font-mono">{formatRupiah(product.price)}</p>
                </button>
              ))}
            </div>
          </div>
                ...
                <>
                  <div className="border-t pt-4 mb-4">
                    ...
                    <button
                      ...
                      disabled={processing || !amountPaid || parseInt(amountPaid) < getTotal()}
